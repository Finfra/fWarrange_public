---
title: fWarrange REST API 문서
description: fWarrange REST API 사용 방법 및 엔드포인트 문서 (한국어)
date: 2026-03-26
---
...
캡처 자동화를 위한 앱 UI 상태 제어. 레이아웃 상세 뷰에서 창 목록 숨기기/표시 또는 앱 선택/해제 알림을 전송합니다.
...
| `excludeApps` | string[]            | 아니오 | 선택에서 제외할 앱 목록 (`selectApps`와 함께 사용)           |
