...
| 에디션                 | 인터페이스        | 가격                | 설치                                                           | 소스             |
| ---------------------- | ----------------- | ------------------- | -------------------------------------------------------------- | ---------------- |
| **fWarrange** (GUI)    | 풀 GUI + 메뉴바   | 유료 (App Store)    | [App Store](https://finfra.kr/product/fWarrange/kr/index.html) | 비공개           |
| **fWarrangeCli** (CLI) | 메뉴바 + REST API | **무료 & 오픈소스** | `brew install finfra/tap/fwarrange-cli`                        | [`cli/`](./cli/) |
