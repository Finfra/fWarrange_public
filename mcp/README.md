...
description: fWarrange REST API를 MCP 도구로 제공하는 서버 안내 (English)
date: 2026-03-26
---
...
Control the app UI state for capture automation (hide/show windows, select/deselect apps).
...
| `excludeApps` | string[]            | No       | Apps to exclude from selection                                 |

**Usage example** (ask Claude):
```
Hide the window list and select only Safari and iTerm2
```
